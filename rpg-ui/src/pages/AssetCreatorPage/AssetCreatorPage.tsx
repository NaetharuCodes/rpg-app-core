...
interface AssetFormData {
  ...
  name: string;
  description: string;
  image: File | string | null; // File for upload, string for selected from library, null for none
}

// Mock images for demonstration - in real app these would come from your asset library
const mockLibraryImages = {
  character: [
    { id: 'char1', url: 'https://via.placeholder.com/768x1024/4F46E5/FFFFFF?text=Character+1', name: 'Knight' },
    { id: 'char2', url: 'https://via.placeholder.com/768x1024/7C3AED/FFFFFF?text=Character+2', name: 'Wizard' },
    { id: 'char3', url: 'https://via.placeholder.com/768x1024/059669/FFFFFF?text=Character+3', name: 'Rogue' },
    { id: 'char4', url: 'https://via.placeholder.com/768x1024/DC2626/FFFFFF?text=Character+4', name: 'Warrior' },
  ],
  creature: [
    { id: 'crea1', url: 'https://via.placeholder.com/768x1024/B91C1C/FFFFFF?text=Creature+1', name: 'Dragon' },
    { id: 'crea2', url: 'https://via.placeholder.com/768x1024/7F1D1D/FFFFFF?text=Creature+2', name: 'Goblin' },
    { id: 'crea3', url: 'https://via.placeholder.com/768x1024/991B1B/FFFFFF?text=Creature+3', name: 'Wolf' },
  ],
  location: [
    { id: 'loc1', url: 'https://via.placeholder.com/768x1024/0369A1/FFFFFF?text=Location+1', name: 'Castle' },
    { id: 'loc2', url: 'https://via.placeholder.com/768x1024/0284C7/FFFFFF?text=Location+2', name: 'Forest' },
    { id: 'loc3', url: 'https://via.placeholder.com/768x1024/0EA5E9/FFFFFF?text=Location+3', name: 'Tavern' },
  ],
  item: [
    { id: 'item1', url: 'https://via.placeholder.com/768x1024/D97706/FFFFFF?text=Item+1', name: 'Sword' },
    { id: 'item2', url: 'https://via.placeholder.com/768x1024/EA580C/FFFFFF?text=Item+2', name: 'Potion' },
    { id: 'item3', url: 'https://via.placeholder.com/768x1024/F59E0B/FFFFFF?text=Item+3', name: 'Shield' },
  ],
};
...
export function AssetCreatorPage() {
  ...
  const handleSave = () => {
    ...
    alert(`${formData.type.charAt(0).toUpperCase() + formData.type.slice(1)} "${formData.name}" created successfully!`);
  ...
  const imagePreviewUrl = uploadPreview || (typeof formData.image === 'string' ? formData.image : null);
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Add a new asset to your library</p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 min-h-[calc(100vh-200px)]">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div>
              <h2 className="text-xl font-semibold text-foreground mb-2">Asset Type</h2>
              <p className="text-muted-foreground mb-6">Choose what type of asset you're creating</p>
...
\`Code\` or code blocks`}
            ...
            {/* Image Selection */}
            <div>
              <h2 className="text-xl font-semibold text-foreground mb-2">Image</h2>
              ...
              <div className="space-y-4">
                ...
                {imageSource === 'library' && (
                  <div>
                    ...
                    >
                      Choose from {formData.type} images ({currentLibraryImages.length} available)
                    </Button>
                  </div>
                )}
                ...
                {imageSource === 'upload' && (
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground mt-3 p-4 bg-muted/20 rounded-lg">
                      <strong>Recommended:</strong> 768x1024px (3:4 ratio)<br/>
                      <strong>Max size:</strong> 5MB | <strong>Formats:</strong> JPG, PNG, WebP
                    </div>
                  </div>
                )}
              </div>
            ...
            <div className="flex items-center justify-between p-6 border-b border-border">
              <div>
                <h2 className="text-xl font-semibold">
                  Choose {formData.type.charAt(0).toUpperCase() + formData.type.slice(1)} Image
                </h2>
